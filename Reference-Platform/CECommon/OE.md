...
The support for B2260 is available in the [meta-st-cannes2 layer](https://github.com/cpriouzeau/meta-st-cannes2).
...
* using the ARM Mali Utgard GPU driver for HiKey and B2260
...
| meta-st-cannes2 (BSP)         | This is the board support layer for STMicroelectronics boards. Currently supports STiH410 and the B2260 board. |
